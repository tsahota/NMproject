...
To generate diagnostics we create a diagnostic template with help of pre-existing templates, here it's `Scripts/basic_gof.Rmd` and run this on m2.  This will create a project specific run report to evaluate your model
