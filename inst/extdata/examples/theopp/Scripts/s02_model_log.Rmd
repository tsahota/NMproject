...
m1s_temp <- m1 %>% child("m1s_temp") %>%  
  update_parameters(m1) %>%
  apply_manual_edit("patch-tarjinde-2021-06-04-17-07-24")
...
## non-grid system consider run_nm_batch() with the "threads" argument to avoid
