## Author: Tarjinder Sahota (klgk669) First created: 2016-01-29 Description: NONMEM
## testing suite Depends on: wait.for.R Run interactively: FALSE Keywords: script,
## package test
...
## m1 = CONTROL5 on cluster m2 = CONTROL5 on head node
