...
###################################
## If NM control stream directory != project base directory, need:
##  setwd(...full path to model directory...)
## and
##  scripts.dir <- ...relative path of scripts directory from model directory...
