## Description: Test NMproject functionality Depends on: gof1.R, wait.for.R Run
## interactively: TRUE Keywords: script, package test
...
file.copy(file.path(getOption("code_library.loc"), "misc/data2.csv"), "Data")
