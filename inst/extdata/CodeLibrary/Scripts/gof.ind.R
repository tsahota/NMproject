...
gof.ind.plot <- function(run.no,primary.key="ORD",models.dir=".",
                         time.var="TIME",id.var="ID",subset,label,log=FALSE){
  ...
  pdf(paste0("Results/explore.nm1.pkind1.",log.lbl,".run.",run.no,".",label,".pdf"),width=12,height=7)
