...
Fill in the ... to include the other directories.

In general there should be a source data directory for 
unmodified source datasets and a derived data directory
for cleaned modelling-ready datasets
