...
- **R**: Location of any custom R functions used in scripts.  These can be loaded with `devtools::load_all()` or by sourcing individually via `source("R/functionname.R")`.
