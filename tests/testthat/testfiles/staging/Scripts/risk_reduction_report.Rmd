...
- Include the REPORT 5 comparison
- Include pass/fail for each section
- Something about configuration? I could have custom packages, 
...
```{r}
level <- params$level ## nm.log2.R needs level defined
print(level)
```


```{r echo=FALSE, message=FALSE, results='hide', warning=FALSE}
source("Scripts/nm.log2.R", local = environment())
```
