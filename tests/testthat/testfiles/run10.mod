...
FILE=sdtab10 NOPRINT ONEHEADER FORMAT=tF13.4
$TABLE ID WT; individual parameters
FILE=patab10 NOPRINT ONEHEADER FORMAT=tF13.4
$TABLE ID ; continuous covariates
FILE=cotab10 NOPRINT ONEHEADER FORMAT=tF13.4
$TABLE ID ; categorical covariates
FILE=catab10 NOPRINT ONEHEADER FORMAT=tF13.4
