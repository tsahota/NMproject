...
working.directory<-'/home/klgk669/test24/Models/1/'
model.directory<-'/home/klgk669/test24/Models/'
results.directory <- '/home/klgk669/test24/Models/'
model.filename<-'run1.mod'
subset.variable<-NULL
mod.suffix <- '.mod'
mod.prefix <- 'run'
tab.suffix <- ''
rscripts.directory <- '/opt/scp/software/psn/4.8.1-foss-2017a/perl/PsN_4_8_1/R-scripts'
