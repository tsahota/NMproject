...
$ESTIMATION METHOD=IMP ISAMPLE=300 NITER=300 RANMETHOD=3S2 CTYPE=3
            CITER=10 CALPHA=0.05 CINTERVAL=3 PRINT=1 NOABORT
            INTERACTION GRD=DDDSS
...
$ESTIMATION METHOD=IMP INTER EONLY=1 MAPITER=0 ISAMPLE=2000 NITER=10
            RANMETHOD=3S2 NOABORT PRINT=1 NSIG=3 SIGL=9 GRD=DDDSS
$COVARIANCE PRINT=E UNCONDITIONAL SIGL=10
$TABLE      ID TIME IPRED IWRES IRES CWRES NPDE FILE=sdtab1 NOPRINT
